...
public class CommonConfig extends Config {
    ...
    protected void reset() {
        ...
        this.rewardsJanuaryItems = List.of("minecraft:oak_log:32", "minecraft:cooked_salmon:16", "minecraft:white_wool:16", "minecraft:cake:1");
        this.rewardsJanuarySpecialItems = List.of("minecraft:cooked_salmon:1", "minecraft:cake:1", "minecraft:cookie:1");
        ...
        this.rewardsAprilSpecialItems = List.of("minecraft:eggs:1", "minecraft:cake:1", "minecraft:cookie:1");
